...
def test_getting_started():
    with allure.step('Checking 1 window'):
        browser.element((AppiumBy.ID, 'org.wikipedia.alpha:id/primaryTextView')).should(have.text('The Free Encyclopedia\n…in over 300 languages'))
        browser.element((AppiumBy.ID, 'org.wikipedia.alpha:id/secondaryTextView')).should(have.text('We’ve found the following on your device:'))
    ...
    with allure.step('Checking New way section'):
        ...
        browser.element((AppiumBy.ID, 'org.wikipedia.alpha:id/secondaryTextView')).should(have.text('Dive down the Wikipedia rabbit'))
    ...
    with allure.step('Checking Reading lists section'):
        ...
        browser.element((AppiumBy.ID, 'org.wikipedia.alpha:id/secondaryTextView')).should(have.text('Join Wikipedia'))
    ...
    with allure.step('Checking Data and Privacy section'):
        ...
        browser.element((AppiumBy.ID, 'org.wikipedia.alpha:id/secondaryTextView')).should(have.text('terms of use'))
